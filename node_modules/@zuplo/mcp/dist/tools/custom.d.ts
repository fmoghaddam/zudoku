import type { InputParamValidator, InputParamValidatorReturn } from "../server/types.js";
/**
 ...
 */
export declare class CustomValidator<T, S extends object = object> implements InputParamValidator<T> {
    readonly jsonSchema: S;
    private readonly parseFn;
    constructor(jsonSchema: S, parseFn: (input: unknown) => InputParamValidatorReturn<T>);
