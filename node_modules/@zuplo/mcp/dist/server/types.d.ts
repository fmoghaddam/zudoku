...
import type { CallToolResult, ServerCapabilities, Tool } from "../mcp/20250618/types.js";
/**
 ...
 * handler
 */
export type ParsedData<V extends InputParamValidator<unknown>> = NonNullable<ReturnType<V["parse"]>["data"]>;
/**
 * Internal MCP server storage object for a registered tool
 *
 * @param V - is a @type InputParamValidator
 */
export type RegisteredTool<V extends InputParamValidator<unknown> = InputParamValidator<unknown>> = {
    tool: Tool;
    validator: V;
