 ...
 */
export type PromptGenerator<V extends InputParamValidator<unknown>> = (args: ParsedData<V>) => Promise<PromptMessage[]> | PromptMessage[];
/**
 ...
 */
export type RegisteredPrompt<V extends InputParamValidator<unknown> = InputParamValidator<unknown>> = {
    prompt: Prompt;
    validator: V;
    generator: PromptGenerator<V>;
};
