...
describe("validateConfig", () => {
    ...
    it("should validate clerk public key format correctly", () => {
        ...
        expect(() => validateConfig(configWithValidAuth0)).toThrowErrorMatchingInlineSnapshot(`
    ...
    it("should reject auth0 domain with protocol in development mode", () => {
        ...
        expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining("Domain must be a host only"));
    });
    ...
    it("should throw error for invalid auth0 domain in production mode", () => {
        ...
        expect(() => validateConfig(configWithInvalidAuth0Domain)).toThrowErrorMatchingInlineSnapshot(`
      [Error: Whoops, looks like there's an issue with your config:
