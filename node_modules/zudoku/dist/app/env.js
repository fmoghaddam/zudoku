...
const getZuploBuildConfig = () => {
    if (!process.env.ZUPLO_BUILD_CONFIG)
        return undefined;
    try {
        const zuploBuildConfig = BuildConfigSchema.parse(JSON.parse(process.env.ZUPLO_BUILD_CONFIG));
        ...
        // biome-ignore lint/suspicious/noConsole: Logging allowed here
        console.error("ZUPLO_BUILD_CONFIG is a reserved environment variable and cannot be used for custom configuration. Please remove it from your environment variables.");
        // biome-ignore lint/suspicious/noConsole: Logging allowed here
        console.log(error);
        return undefined;
    }
