...
describe("Generate OpenAPI schema module", () => {
    it("should handle basic schema refs", async () => {
        ...
        const successSchema = schema.paths["/pets"].get.responses["200"].content["application/json"]
            .schema;
        const errorSchema = schema.paths["/pets"].get.responses.default.content["application/json"]
            .schema;
    ...
    it("should handle URL-encoded characters in references", async () => {
        ...
        const { schema } = await executeCode(await generateCode(input));
        expect(schema.info.schema).toStrictEqual(input.components.schemas["Type With Space"]);
    });
    ...
    it("should generate correct code for refs with siblings", async () => {
        ...
        expect(code).toContain('const __merged_0 = Object.assign({}, __refMap["#/components/schemas/Pet"], {\n  "description": "The pet data"\n});');
        expect(code).toContain('Object.defineProperty(__merged_0, "__$ref", { value: __refMapPaths[0], enumerable: false });');
    ...
    it("should handle OpenAPI v3.1 refs alongside description and summary", async () => {
        ...
        const { schema } = await executeCode(await generateCode(input));
        const responseSchema200 = schema.paths["/pets"].get.responses["200"].content["application/json"]
            .schema;
        const responseSchema201 = schema.paths["/pets"].get.responses["201"].content["application/json"]
            .schema;
...
//# sourceMappingURL=schema-codegen.test.js.map