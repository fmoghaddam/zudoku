...
const injectResult = (variableName, tree, result) => {
...
const executeFunction = async (file, code, importNodes) => {
    const context = {
        result: "",
        process,
        console,
...
export const remarkStaticGeneration = () => async (tree, file) => {
    const imports = [];
...
//# sourceMappingURL=remark-static-generation.js.map