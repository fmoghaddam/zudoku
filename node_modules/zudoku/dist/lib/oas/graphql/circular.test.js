...
import { CIRCULAR_REF, handleCircularRefs, SCHEMA_REF_PREFIX, } from "./circular.js";
describe("handleCircularRefs", () => {
    ...
    it("should detect circular refs via __$ref path", () => {
        ...
        inner.properties = { parent: obj };
        const result = handleCircularRefs(obj);
        expect(result.properties.child).toBe(`${SCHEMA_REF_PREFIX}#/components/schemas/Node`);
    });
    ...
    it("should allow same ref path in different branches of the tree", () => {
        ...
        expect(result.properties.user.properties.id).not.toBe(expect.stringContaining(SCHEMA_REF_PREFIX));
        expect(result.properties.post.properties.id).not.toBe(expect.stringContaining(SCHEMA_REF_PREFIX));
    });
...
//# sourceMappingURL=circular.test.js.map