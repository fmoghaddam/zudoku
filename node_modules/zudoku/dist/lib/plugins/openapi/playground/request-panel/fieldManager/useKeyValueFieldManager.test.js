...
import { useKeyValueFieldManager, } from "../useKeyValueFieldManager.js";
const createWrapper = (defaultValues) => {
    const Wrapper = ({ children }) => {
        ...
        return _jsx(FormProvider, { ...form, children: children });
    };
    return Wrapper;
};
describe("useKeyValueFieldManager", () => {
    ...
    describe("auto-remove behavior", () => {
        ...
        it("should focus name field when current row is auto-removed", async () => {
            const TestComponent = () => {
                ...
                return manager.fields.map((f, i) => (_jsxs("div", { children: [_jsx("input", { ...manager.getNameInputProps(i), "data-testid": `name-${i}` }), _jsx("input", { ...manager.getValueInputProps(i), "data-testid": `value-${i}` })] }, f.id)));
            };
            ...
            const { getByTestId } = render(_jsx(Wrapper, { children: _jsx(TestComponent, {}) }));
            const firstNameInput = getByTestId("name-0");
            const firstValueInput = getByTestId("value-0");
    ...
    describe("File type support", () => {
        it("should handle File values correctly", async () => {
            ...
            expect(value.name).toBe("test.txt");
        });
    ...
    describe("keyboard navigation", () => {
        ...
        it("should focus next row's name field when Enter is pressed in value field", async () => {
            const TestComponent = () => {
                ...
                return (_jsx("div", { children: manager.fields.map((f, i) => (_jsxs("div", { children: [_jsx("input", { ...manager.getNameInputProps(i), "data-testid": `name-${i}` }), _jsx("input", { ...manager.getValueInputProps(i), "data-testid": `value-${i}` })] }, `field-${f.id}`))) }));
            };
            const Wrapper = createWrapper({
                fields: [{ name: "test", value: "value", active: true }],
            });
    ...
    describe("helper methods", () => {
        ...
        it("should provide correct props for remove button", async () => {
            ...
            const lastRemoveProps = result.current.manager.getRemoveButtonProps(lastIndex);
            expect(lastRemoveProps.disabled).toBe(true);
        });
    });
});
//# sourceMappingURL=useKeyValueFieldManager.test.js.map