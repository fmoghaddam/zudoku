...
describe("removeExtensions", () => {
    it("removes all x- extensions by default", () => {
        ...
        expect(processed).toHaveProperty(["paths", "/test", "get", "responses", "200", "description"], "OK");
    ...
    it("removes only specified x- extensions when names are provided", () => {
        ...
        expect(processed.paths["/test"].parameters[0]["x-param-ext"]).toBeUndefined();
...
//# sourceMappingURL=removeExtensions.test.js.map