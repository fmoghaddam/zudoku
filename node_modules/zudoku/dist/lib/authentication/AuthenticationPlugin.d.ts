import type { CommonPlugin, NavigationPlugin, ProfileMenuPlugin } from "../core/plugins.js";
type PluginInterface = NavigationPlugin & CommonPlugin & ProfileMenuPlugin;
export declare class CoreAuthenticationPlugin implements PluginInterface {
    getRoutes(): {
        path: string;
