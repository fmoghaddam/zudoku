...
export const Toc = ({ entries }) => {
    ...
    return (_jsxs("aside", { className: "sticky scrollbar top-8 lg:top-(--header-height) h-[calc(100vh-var(--header-height))] pt-(--padding-content-top) pb-(--padding-content-bottom) overflow-y-auto ps-1 text-sm", children: [_jsxs("div", { className: "flex items-center gap-2 font-medium mb-2", children: [_jsx(ListTreeIcon, { size: 16 }), "On this page"] }), _jsxs("div", { className: "relative ms-px ps-4", children: [_jsx("div", { className: "absolute inset-0 end-auto bg-border w-[1.5px]" }), _jsx("div", { className: cn("absolute start-0 -translate-y-1 h-6 w-[2.5px] bg-primary", paintedOnce.current &&
                            "ease-out [transition:top_150ms,opacity_325ms]"), style: indicatorStyle }), _jsx("ul", { ref: listWrapperRef, className: "relative font-medium list-none space-y-2", children: entries.map((item) => (_jsx(TocItem, { isActive: item.id === activeAnchor, item: item, className: "ps-0", children: item.children && (_jsx("ul", { className: "list-none ps-4 pt-2 space-y-2", children: item.children.map((child) => (_jsx(TocItem, { item: child, isActive: child.id === activeAnchor }, child.id))) })) }, item.id))) })] })] }));
};
