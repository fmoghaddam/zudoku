...
const Bootstrap = ({ router, hydrate = false, }) => (_jsx(StrictMode, { children: _jsx(QueryClientProvider, { client: queryClient, children: _jsx(HydrationBoundary, { state: hydrate ? window.DATA : undefined, children: _jsx(BypassProtectedRoutesContext, { value: false, children: _jsx(HelmetProvider, { children: _jsx(RouterProvider, { router: router }) }) }) }) }) }));
