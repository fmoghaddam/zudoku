...
describe("mergeConfig", () => {
    ...
    test("does not clone React element children", () => {
        const child = _jsx("strong", { children: "Bold" });
        const element = _jsxs("div", { children: [child, " text"] });
        ...
        expect(result.site.banner.message.props.children).toBe(element.props.children);
    });
...
//# sourceMappingURL=transform-config.test.js.map