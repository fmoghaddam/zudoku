...
describe("flattenAllOf", () => {
    ...
    it("should recursively flatten allOf in nested properties", () => {
        ...
        const result = flattenAllOf(schema);
        invariant(typeof result === "object" && result.properties, "Result is not a schema");
    ...
    it("should flatten allOf in array items", () => {
        ...
        const result = flattenAllOf(schema);
        invariant(typeof result === "object" && result.items, "Result is not a schema");
    ...
    it("should flatten allOf in tuple items", () => {
        ...
        const result = flattenAllOf(schema);
        invariant(typeof result === "object" && Array.isArray(result.items), "Result is not a schema");
    ...
    it("should flatten allOf in additionalProperties", () => {
        ...
        const result = flattenAllOf(schema);
        invariant(typeof result === "object" && result.additionalProperties, "Result is not a schema");
        expect(result.additionalProperties).toMatchObject({
            type: "object",
            properties: {
                id: { type: "string" },
                name: { type: "string" },
    ...
    it("should flatten allOf within anyOf", () => {
        ...
        const result = flattenAllOf(schema);
        invariant(typeof result === "object" && result.anyOf, "Result is not a schema");
    ...
    it("should flatten allOf within oneOf", () => {
        ...
        const result = flattenAllOf(schema);
        invariant(typeof result === "object" && result.oneOf, "Result is not a schema");
...
describe("flattenAllOf processor", () => {
    ...
    it("should handle deeply nested allOf in request bodies", async () => {
        ...
        const requestSchema = result.paths?.["/bookings"]?.post?.requestBody?.content?.["application/json"]?.schema;
