...
describe("getIssuer", () => {
    ...
    it("should throw error for invalid clerk public key format", async () => {
        ...
        await expect(getIssuer(config)).rejects.toThrow("Clerk public key is invalid");
    });
    ...
    it("should return azureb2c issuer for azureb2c authentication", async () => {
        ...
        const result = await getIssuer(config);
        expect(result).toBe("https://example.b2clogin.com/example.onmicrosoft.com/v2.0/");
    });
    ...
    it("should throw error for unsupported authentication type", async () => {
        ...
        await expect(getIssuer(config)).rejects.toThrow("Unsupported authentication type");
    });
});
