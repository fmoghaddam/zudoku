...
async function fixImports(filePath) {
    ...
    let result = data.replace(/(import|export) (.*) from (['"])(\.\/[^'"]*)\3/g, (match, keyword, p1, quote, p2) => p2.endsWith(".js")
        ? match
        : `${keyword} ${p1} from ${quote}${p2}.js${quote}`);
    // Handle dynamic imports
    result = result.replace(/import\((['"])(\.\/[^'"]*)\1\)/g, (match, quote, p2) => p2.endsWith(".js") ? match : `import(${quote}${p2}.js${quote})`);
