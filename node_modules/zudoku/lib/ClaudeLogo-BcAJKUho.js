...
import { ArrowLeftIcon as i, ArrowRightIcon as c } from "lucide-react";
import { L as e } from "./chunk-EPOLDU6W-CLHrVxOG.js";
import { c as n } from "./cn-5-Gd1Dss.js";
import { Button as r } from "./ui/Button.js";
import "react";
import "./Zudoku-BPvTuMy8.js";
...
const j = ({
  ...
  const s = "group min-w-0 transition-all p-5 space-x-1 rtl:space-x-reverse hover:text-foreground";
  return /* @__PURE__ */ l.jsxs(
    "div",
    {
      ...
      children: [
        t && /* @__PURE__ */ l.jsx(r, { variant: "ghost", className: "min-w-0 max-w-full", asChild: !0, children: /* @__PURE__ */ l.jsxs(e, { to: t.to, relative: "path", className: s, children: [
          /* @__PURE__ */ l.jsx(i, { size: 14, strokeWidth: 2.5 }),
          /* @__PURE__ */ l.jsx("span", { className: "text-lg truncate", children: t.label })
        ] }) }),
        a && /* @__PURE__ */ l.jsx(r, { variant: "ghost", className: "ms-auto min-w-0 max-w-full", asChild: !0, children: /* @__PURE__ */ l.jsxs(e, { to: a.to, relative: "path", className: s, children: [
          /* @__PURE__ */ l.jsx("span", { className: "text-lg truncate", children: a.label }),
          /* @__PURE__ */ l.jsx(c, { size: 14, strokeWidth: 2.5 })
        ] }) })
      ]
    }
  );
}, v = (t) => /* @__PURE__ */ l.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 320 320", ...t, children: [
  /* @__PURE__ */ l.jsx("title", { children: "ChatGPT" }),
  /* @__PURE__ */ l.jsx(
    "path",
    {
      fill: "currentColor",
  ...
  "svg",
  {
    ...
    ...t,
    children: [
      /* @__PURE__ */ l.jsx("title", { children: "Claude" }),
      /* @__PURE__ */ l.jsx(
        "path",
        {
          fill: "#D97757",
...
//# sourceMappingURL=ClaudeLogo-BcAJKUho.js.map
