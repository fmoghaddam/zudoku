...
// node_modules/@scalar/openapi-parser/dist/schemas/v2.0/schema.js
var schema_default = {
...
// node_modules/@scalar/openapi-parser/dist/schemas/v3.0/schema.js
var schema_default2 = {
...
// node_modules/@scalar/openapi-parser/dist/schemas/v3.1/schema.js
var schema_default3 = {
...
// node_modules/@scalar/openapi-parser/dist/configuration/index.js
...
// node_modules/@scalar/openapi-parser/dist/lib/Validator/Validator.js
var import_ajv_draft_04 = __toESM(require_dist(), 1);
var import_ajv_formats = __toESM(require_dist2(), 1);
var import__ = __toESM(require__(), 1);

// node_modules/@scalar/openapi-parser/dist/utils/details.js
...
// node_modules/@scalar/openapi-parser/dist/utils/getEntrypoint.js
function getEntrypoint(filesystem) {
  return filesystem?.find((file) => file.isEntrypoint);
}

// node_modules/@scalar/openapi-parser/dist/utils/unescapeJsonPointer.js
function unescapeJsonPointer(uri) {
  return decodeURI(uri.replace(/~1/g, "/").replace(/~0/g, "~"));
}

// node_modules/@scalar/openapi-parser/dist/utils/getSegmentsFromPath.js
...
// node_modules/@scalar/openapi-parser/dist/utils/traverse.js
...
// node_modules/@scalar/openapi-parser/dist/utils/getListOfReferences.js
...
// node_modules/@scalar/openapi-parser/dist/utils/isFilesystem.js
...
// node_modules/@scalar/openapi-parser/dist/utils/normalize.js
...
// node_modules/@scalar/openapi-parser/dist/utils/makeFilesystem.js
...
// node_modules/@scalar/openapi-parser/dist/utils/resolveReferences.js
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/utils.js
var eq = (x) => (y) => x === y;
var not = (fn) => (x) => !fn(x);
...
var getErrors = (node) => node?.errors || [];
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/validation-errors/base.js
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/validation-errors/additional-prop.js
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/validation-errors/default.js
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/validation-errors/enum.js
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/validation-errors/pattern.js
var PatternValidationError = class extends BaseValidationError {
  constructor(...args) {
    super(...args);
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/validation-errors/required.js
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/validation-errors/unevaluated-prop.js
var UnevaluatedPropValidationError = class extends BaseValidationError {
  constructor(...args) {
    super(...args);
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/helpers.js
...
// node_modules/@scalar/openapi-parser/dist/utils/betterAjvErrors/index.js
...
// node_modules/@scalar/openapi-parser/dist/utils/transformErrors.js
...
// node_modules/@scalar/openapi-parser/dist/utils/dereference.js
...
// node_modules/@scalar/openapi-parser/dist/utils/escapeJsonPointer.js
function escapeJsonPointer(str) {
  return str.replace(/~/g, "~0").replace(/\//g, "~1");
}

// node_modules/@scalar/openapi-parser/dist/utils/filter.js
...
// node_modules/@scalar/openapi-parser/dist/utils/isJson.js
...
// node_modules/@scalar/openapi-parser/dist/utils/isObject.js
var isObject = (obj) => typeof obj === "object" && !Array.isArray(obj) && obj !== null;

// node_modules/@scalar/openapi-parser/dist/utils/isYaml.js
...
// node_modules/@scalar/openapi-parser/dist/utils/load/load.js
...
// node_modules/@scalar/openapi-parser/dist/utils/upgradeFromThreeToThreeOne.js
...
function isSchemaPath(path) {
  ...
  }) || path.includes("schema") || path.some((segment) => segment.endsWith("Schema"));
}

// node_modules/@scalar/openapi-parser/dist/utils/upgradeFromTwoToThree.js
...
// node_modules/@scalar/openapi-parser/dist/utils/upgrade.js
...
// node_modules/@scalar/openapi-parser/dist/utils/validate.js
...
// node_modules/@scalar/openapi-parser/dist/utils/openapi/utils/workThroughQueue.js
async function workThroughQueue(queue) {
  ...
  for (const task of queue.tasks) {
    ...
    if (name === "load") {
      ...
      result = {
        ...result,
        ...await dereference2(currentSpecification, options)
      };
...
// node_modules/@scalar/openapi-parser/dist/utils/openapi/actions/details.js
async function details2(queue) {
  const { filesystem } = await workThroughQueue(queue);
  return details(getEntrypoint(filesystem).specification);
}

// node_modules/@scalar/openapi-parser/dist/utils/openapi/actions/files.js
async function files(queue) {
  const { filesystem } = await workThroughQueue(queue);
  return filesystem;
}

// node_modules/@scalar/openapi-parser/dist/utils/openapi/actions/get.js
...
// node_modules/@scalar/openapi-parser/dist/utils/toJson.js
var toJson = (value) => JSON.stringify(value, null, 2);

// node_modules/@scalar/openapi-parser/dist/utils/openapi/actions/toJson.js
async function toJson2(queue) {
  const { filesystem } = await workThroughQueue(queue);
  return toJson(getEntrypoint(filesystem).specification);
}

// node_modules/@scalar/openapi-parser/dist/utils/toYaml.js
var toYaml = (value) => stringify(value);

// node_modules/@scalar/openapi-parser/dist/utils/openapi/actions/toYaml.js
async function toYaml2(queue) {
  const { filesystem } = await workThroughQueue(queue);
  return toYaml(getEntrypoint(filesystem).specification);
}

// node_modules/@scalar/openapi-parser/dist/utils/openapi/utils/queueTask.js
...
// node_modules/@scalar/openapi-parser/dist/utils/openapi/commands/dereferenceCommand.js
function dereferenceCommand(previousQueue, options) {
  ...
  return {
    details: () => details2(queue),
    files: () => files(queue),
    get: () => get(queue),
    toJson: () => toJson2(queue),
    toYaml: () => toYaml2(queue)
  };
}

// node_modules/@scalar/openapi-parser/dist/utils/openapi/commands/filterCommand.js
...
// node_modules/@scalar/openapi-parser/dist/utils/openapi/commands/validateCommand.js
...
// node_modules/@scalar/openapi-parser/dist/utils/openapi/commands/upgradeCommand.js
...
// node_modules/@scalar/openapi-parser/dist/utils/openapi/commands/loadCommand.js
...
// node_modules/@scalar/openapi-parser/dist/utils/openapi/openapi.js
...
// node_modules/@scalar/openapi-parser/dist/utils/transform/utils/addInfoObject.js
var DEFAULT_TITLE = "API";
var DEFAULT_VERSION = "1.0";
var addInfoObject = (definition) => ({
  ...definition,
  info: {
    ...definition.info,
...
// node_modules/@scalar/openapi-parser/dist/utils/transform/utils/addLatestOpenApiVersion.js
var DEFAULT_OPENAPI_VERSION = "3.1.1";
var addLatestOpenApiVersion = (definition) => ({
  openapi: definition.openapi ?? DEFAULT_OPENAPI_VERSION,
  ...definition
});

// node_modules/@scalar/openapi-parser/dist/utils/transform/utils/addMissingTags.js
var addMissingTags = (definition) => {
  if (!definition.paths) {
    return definition;
  }
...
// node_modules/@scalar/openapi-parser/dist/utils/transform/utils/normalizeSecuritySchemes.js
var normalizeSecuritySchemes = (definition) => {
...
// node_modules/@scalar/openapi-parser/dist/utils/transform/utils/rejectSwaggerDocuments.js
var rejectSwaggerDocuments = (defintion) => {
...
// node_modules/@scalar/openapi-parser/dist/utils/transform/sanitize.js
...
//# sourceMappingURL=zudoku___@scalar_openapi-parser.js.map
