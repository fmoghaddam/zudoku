...
// node_modules/zudoku/lib/index-DmNq2fbN.js
var dt = Symbol.for("yaml.alias");
var lt = Symbol.for("yaml.document");
var G = Symbol.for("yaml.map");
var qt = Symbol.for("yaml.pair");
var F = Symbol.for("yaml.scalar");
var he = Symbol.for("yaml.seq");
var P = Symbol.for("yaml.node.type");
var W = (s) => !!s && typeof s == "object" && s[P] === dt;
var Z = (s) => !!s && typeof s == "object" && s[P] === lt;
var de = (s) => !!s && typeof s == "object" && s[P] === G;
var T = (s) => !!s && typeof s == "object" && s[P] === qt;
var E = (s) => !!s && typeof s == "object" && s[P] === F;
var pe = (s) => !!s && typeof s == "object" && s[P] === he;
function L(s) {
...
var Rt = (s) => (E(s) || L(s)) && !!s.anchor;
var M = Symbol("break visit");
var Ft = Symbol("skip children");
var R = Symbol("remove node");
function ee(s, e) {
  const t = Ut(e);
...
var Ms = (s) => s.replace(/[!,[\]{}]/g, (e) => Bs[e]);
var B = class _B {
  constructor(e, t) {
    this.docStart = null, this.docEnd = false, this.yaml = Object.assign({}, _B.defaultYaml, e), this.tags = Object.assign({}, _B.defaultTags, t);
  }
  clone() {
    const e = new _B(this.yaml, this.tags);
    ...
    switch (this.yaml.version) {
      ...
      case "1.2":
        this.atNextDocument = false, this.yaml = {
          explicit: _B.defaultYaml.explicit,
          version: "1.2"
        }, this.tags = Object.assign({}, _B.defaultTags);
        break;
    }
    return e;
  }
   ...
   */
  add(e, t) {
    this.atNextDocument && (this.yaml = { explicit: _B.defaultYaml.explicit, version: "1.1" }, this.tags = Object.assign({}, _B.defaultTags), this.atNextDocument = false);
    ...
    switch (i) {
      case "%TAG": {
        if (n.length !== 2 && (t(0, "%TAG directive should contain exactly two parts"), n.length < 2))
          return false;
        const [r, o] = n;
        return this.tags[r] = o, true;
      }
      case "%YAML": {
        if (this.yaml.explicit = true, n.length !== 1)
          return t(0, "%YAML directive should contain exactly one part"), false;
        const [r] = n;
        if (r === "1.1" || r === "1.2")
          return this.yaml.version = r, true;
        {
          const o = /^\d+\.\d+$/.test(r);
          return t(6, `Unsupported YAML version ${r}`, o), false;
        }
      }
      default:
        return t(0, `Unknown directive ${i}`, true), false;
    }
  }
  /**
...
B.defaultYaml = { explicit: false, version: "1.2" };
...
var Wt = (s) => !s || typeof s != "function" && typeof s != "object";
var O = class extends pt {
  constructor(e) {
...
var we = (s) => s == null || typeof s == "object" && !!s[Symbol.iterator]().next().done;
var Ht = class extends pt {
  constructor(e, t) {
...
var Ds = (s) => s.replace(/^(?!$)(?: $)?/gm, "#");
function U(s, e) {
  return /^\n+$/.test(s) ? s.substring(1) : e ? s.replace(/^(?! *$)/gm, e) : s;
}
var H = (s, e, t) => s.endsWith(`
`) ? U(t, e) : t.includes(`
`) ? `
` + U(t, e) : (s.endsWith(" ") ? "" : " ") + t;
var Xt = "flow";
...
` && k !== "	" && (u = h);
      ...
      if (h >= f)
        if (u)
          ...
          if (d[k])
            return s;
          c.push(k), d[k] = true, f = k + a, u = void 0;
        } else
          y = true;
    }
    m = S;
...
`, a += 2;
  ...
  return o = l ? o + t.slice(l) : t, n ? o : Ue(o, r, Be, Ve(e, false));
}
function ct(s, e) {
  if (e.options.singleQuote === false || e.implicitKey && s.includes(`
`) || /[ \t]\n|\n[ \t]/.test(s))
    return Se(s, e);
  const t = e.indent || (Je(s) ? "  " : ""), n = "'" + s.replace(/'/g, "''").replace(/\n+/g, `$&
${t}`) + "'";
  return e.implicitKey ? n : Ue(n, t, Xt, Ve(e, false));
}
function le(s, e) {
...
function Me({ comment: s, type: e, value: t }, n, i, r) {
  ...
  if (!o || /\n[\t ]+$/.test(t) || /^\s*$/.test(t))
    return le(t, n);
  const c = n.indent || (n.forceBlockIndent || Je(t) ? "  " : ""), d = o === "literal" ? true : o === "folded" || e === O.BLOCK_FOLDED ? false : e === O.BLOCK_LITERAL ? true : !qs(t, a, c.length);
  if (!t)
    return d ? `|
` : `>
`;
...
`))
  ...
  if (Je(r)) {
    if (a === "")
      return e.forceBlockIndent = true, Me(s, e, t, n);
    if (l && a === c)
      return le(r, e);
  }
  const f = r.replace(/\n+/g, `$&
${a}`);
  ...
  return l ? f : Ue(f, a, Xt, Ve(e, false));
}
function Ae(s, e, t, n) {
...
function Vs({ key: s, value: e }, t, n, i) {
  ...
  let y = false, h = false, p = fe(s, t, () => y = true, () => h = true);
...
${l}:`) : (p = `${p}:`, u && (p += H(p, t.indent, c(u))));
  let b, w, S;
  $(e) ? (b = !!e.spaceBefore, w = e.commentBefore, S = e.comment) : (b = false, w = null, S = null, e && typeof e == "object" && (e = o.createNode(e))), t.implicitKey = false, !m && !u && E(e) && (t.indentAtStart = p.length + 1), h = false, !d && a.length >= 2 && !t.inFlow && !m && pe(e) && !e.flow && !e.tag && !e.anchor && (t.indent = t.indent.substring(2));
  let k = false;
  const N = fe(e, t, () => k = true, () => h = true);
  let A = " ";
  if (u || b || w) {
    if (A = b ? `
` : "", w) {
...
`), _ = g !== -1, J = t.inFlow ?? e.flow ?? e.items.length === 0;
    if (_ || !J) {
      ...
      if (_ && (I === "&" || I === "!")) {
        let C = N.indexOf(" ");
        I === "&" && C !== -1 && C < g && N[C + 1] === "!" && (C = N.indexOf(" ", C + 1)), (C === -1 || g < C) && (te = true);
      }
      te || (A = `
${t.indent}`);
    }
...
var Js = (s, e) => (V.identify(e) || E(e) && (!e.type || e.type === O.PLAIN) && V.identify(e.value)) && s?.doc.schema.tags.some((t) => t.tag === V.tag && t.default);
function Zt(s, e, t) {
...
function Ys(s, e, t) {
  ...
  if ($(s) && t?.doc) {
    ...
    if (!t.mapKeyWarned) {
      ...
      r.length > 40 && (r = r.substring(0, 36) + '..."'), xt(t.doc.options.logLevel, `Keys with collection values will be stringified due to JS Object restrictions: ${r}. Set mapAsMap: true to use object keys.`), t.mapKeyWarned = true;
    }
    return i;
  }
...
var v = class _v {
  ...
  clone(e) {
    ...
    return $(t) && (t = t.clone(e)), $(n) && (n = n.clone(e)), new _v(t, n);
  }
  toJSON(e, t) {
...
function Gs({ comment: s, items: e }, t, { blockItemPrefix: n, flowChars: i, itemIndent: r, onChompKeep: o, onComment: l }) {
  ...
  for (let y = 0; y < e.length; ++y) {
    ...
    f = false;
    let b = fe(h, d, () => p = null, () => f = true);
    p && (b += H(b, r, c(p))), f && p && (f = false), u.push(n + b);
  }
  let m;
  if (u.length === 0)
    m = i.start + i.end;
...
function Qs({ items: s }, e, { flowChars: t, itemIndent: n }) {
  ...
  for (let y = 0; y < s.length; ++y) {
    ...
    let p = null;
    if ($(h))
      h.spaceBefore && f.push(""), Pe(e, f, h.commentBefore, false), h.comment && (p = h.comment);
    else if (T(h)) {
      const w = $(h.key) ? h.key : null;
      w && (w.spaceBefore && f.push(""), Pe(e, f, w.commentBefore, false), w.comment && (c = true));
      const S = $(h.value) ? h.value : null;
      S ? (S.comment && (p = S.comment), S.commentBefore && (c = true)) : h.value == null && w?.comment && (p = w.comment);
    }
    p && (c = true);
    let b = fe(h, a, () => p = null);
    y < s.length - 1 && (b += ","), p && (b += H(b, n, l(p))), !c && (f.length > d || b.includes(`
`)) && (c = true), f.push(b), d = f.length;
  }
...
var K = class extends Ht {
  ...
  delete(e) {
    ...
    return t ? this.items.splice(this.items.indexOf(t), 1).length > 0 : false;
  }
  get(e, t) {
  ...
  toString(e, t, n) {
    ...
    return !e.allNullValues && this.hasAllNullValues(false) && (e = Object.assign({}, e, { allNullValues: true })), ts(this, e, {
      blockItemPrefix: "",
      flowChars: { start: "{", end: "}" },
      itemIndent: e.indent || "",
      onChompKeep: n,
...
var Q = class extends Ht {
  ...
  delete(e) {
    const t = Le(e);
    return typeof t != "number" ? false : this.items.splice(t, 1).length > 0;
  }
  get(e, t) {
    const n = Le(e);
    if (typeof n != "number")
...
var Ye = {
  ...
  resolve: (s) => s,
  stringify(s, e, t, n) {
    return e = Object.assign({ actualString: true }, e), Ae(s, e, t, n);
  }
};
var Ge = {
  identify: (s) => s == null,
...
var Qe = (s) => typeof s == "bigint" || Number.isInteger(s);
var gt = (s, e, t, { intAsBigInt: n }) => n ? BigInt(s) : parseInt(s.substring(e), t);
function rs(s, e, t) {
  const { value: n } = s;
...
var $e = ({ value: s }) => JSON.stringify(s);
var Hs = [
  {
    identify: (s) => typeof s == "string",
    default: true,
...
var ae = class _ae extends Q {
  constructor() {
    super(), this.add = K.prototype.add.bind(this), this.delete = K.prototype.delete.bind(this), this.get = K.prototype.get.bind(this), this.has = K.prototype.has.bind(this), this.set = K.prototype.set.bind(this), this.tag = _ae.tag;
  }
  /**
...
var Ee = (s) => typeof s == "bigint" || Number.isInteger(s);
...
var ce = class _ce extends K {
  ...
  toString(e, t, n) {
    ...
    if (this.hasAllNullValues(true))
      return super.toString(Object.assign({}, e, { allNullValues: true }), t, n);
...
function an(s, e) {
  ...
  if (e.directives !== false && s.directives) {
    const a = s.directives.toString(s);
    a ? (t.push(a), n = true) : s.directives.docStart && (n = true);
  }
  n && t.push("---");
...
var ge = class _ge {
   ...
   */
  clone() {
    const e = Object.create(_ge.prototype, {
      [P]: { value: lt }
    });
  ...
  createNode(e, t, n) {
    ...
    const { aliasDuplicateObjects: r, anchorPrefix: o, flow: l, keepUndefined: a, onTagObj: c, tag: d } = n ?? {}, { onAnchor: f, setAnchors: u, sourceObjects: m } = Ks(
      ...
      aliasDuplicateObjects: r ?? true,
      keepUndefined: a ?? false,
      onAnchor: f,
      onTagObj: c,
      replacer: i,
      schema: this.schema,
   ...
   */
  delete(e) {
    return se(this.contents) ? this.contents.delete(e) : false;
  }
  /**
   * Removes a value from the document.
   * @returns `true` if the item was found and removed.
   */
  deleteIn(e) {
    return we(e) ? this.contents == null ? false : (this.contents = null, true) : se(this.contents) ? this.contents.deleteIn(e) : false;
  }
  /**
   * Returns item at `key`, or `undefined` if not found. By default unwraps
   * scalar values from their surrounding node; to disable set `keepScalar` to
   ...
   */
  has(e) {
    return L(this.contents) ? this.contents.has(e) : false;
  }
  /**
   * Checks if the document includes a value at `path`.
   */
  hasIn(e) {
    return we(e) ? this.contents !== void 0 : L(this.contents) ? this.contents.hasIn(e) : false;
  }
  /**
  ...
  setSchema(e, t = {}) {
    ...
    switch (e) {
      case "1.1":
        this.directives ? this.directives.yaml.version = "1.1" : this.directives = new B({ version: "1.1" }), n = { resolveKnownTags: false, schema: "yaml-1.1" };
        break;
      case "1.2":
      case "next":
        this.directives ? this.directives.yaml.version = e : this.directives = new B({ version: e }), n = { resolveKnownTags: true, schema: "core" };
        break;
      case null:
   ...
   */
  toJSON(e, t) {
    return this.toJS({ json: true, jsonArg: e, mapAsMap: false, onAnchor: t });
  }
...
function ue(s, { flow: e, indicator: t, next: n, offset: i, onError: r, parentIndent: o, startOnNewline: l }) {
  let a = false, c = l, d = l, f = "", u = "", m = false, y = false, h = null, p = null, b = null, w = null, S = null, k = null, N = null;
  for (const g of s)
    switch (y && (g.type !== "space" && g.type !== "newline" && g.type !== "comma" && r(g.offset, "MISSING_CHAR", "Tags and anchors must be separated from the next token by white space"), y = false), h && (c && g.type !== "comment" && g.type !== "newline" && r(h, "TAB_AS_INDENT", "Tabs are not allowed as indentation"), h = null), g.type) {
      case "space":
        !e && (t !== "doc-start" || n?.type !== "flow-collection") && g.source.includes("	") && (h = g), d = true;
        break;
      case "comment": {
        d || r(g, "MISSING_CHAR", "Comments must be separated from other tokens by white space characters");
        const _ = g.source.substring(1) || " ";
        f ? f += u + _ : f = _, u = "", c = false;
        break;
      }
      case "newline":
        c ? f ? f += g.source : (!k || t !== "seq-item-ind") && (a = true) : u += g.source, c = true, m = true, (p || b) && (w = g), d = true;
        break;
      case "anchor":
        p && r(g, "MULTIPLE_ANCHORS", "A node can have at most one anchor"), g.source.endsWith(":") && r(g.offset + g.source.length - 1, "BAD_ALIAS", "Anchor ending in : is ambiguous", true), p = g, N ?? (N = g.offset), c = false, d = false, y = true;
        break;
      case "tag": {
        b && r(g, "MULTIPLE_TAGS", "A node can have at most one tag"), b = g, N ?? (N = g.offset), c = false, d = false, y = true;
        break;
      }
      case t:
        (p || b) && r(g, "BAD_PROP_ORDER", `Anchors and tags must be after the ${g.source} indicator`), k && r(g, "UNEXPECTED_TOKEN", `Unexpected ${g.source} in ${e ?? "collection"}`), k = g, c = t === "seq-item-ind" || t === "explicit-key-ind", d = false;
        break;
      case "comma":
        if (e) {
          S && r(g, "UNEXPECTED_TOKEN", `Unexpected , in ${e}`), S = g, c = false, d = false;
          break;
        }
      // else fallthrough
      default:
        r(g, "UNEXPECTED_TOKEN", `Unexpected ${g.type} token`), c = false, d = false;
    }
...
function ut(s, e, t) {
  if (e?.type === "flow-collection") {
    const n = e.end[0];
    n.indent === s && (n.source === "]" || n.source === "}") && Ne(e) && t(n, "BAD_INDENT", "Flow end indicator should be more indented than parent", true);
  }
}
function bs(s, e, t) {
...
` + h.comment : l.comment = h.comment);
    ...
    t.schema.compat && ut(n.indent, u, i), t.atKey = false, bs(t, l.items, w) && i(b, "DUPLICATE_KEY", "Map keys must be unique");
    const S = ue(m ?? [], {
...
function fn({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
  ...
  t.atRoot && (t.atRoot = false), t.atKey && (t.atKey = false);
  let a = n.offset, c = null;
...
var st = "Block collections are not allowed within flow collections";
var nt = (s) => s && (s.type === "block-map" || s.type === "block-seq");
function un({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
  ...
  c.flow = true;
  const d = t.atRoot;
  d && (t.atRoot = false), t.atKey && (t.atKey = false);
...
` + I : g.comment = I, A.comment = A.comment.substring(I.length + 1);
    ...
    if (!o && !k && !A.found) {
      ...
      nt(S) && i(g.range, "BLOCK_IN_FLOW", st), t.atKey = false;
      const _ = ue(k ?? [], {
        flow: l,
        indicator: "map-value-ind",
        next: N,
...
function hn(s, e, t, n, i) {
  ...
  if (!a) {
    ...
    if (u && u.collection === l)
      e.schema.tags.push(Object.assign({}, u, { default: false })), a = u;
    else
      return u ? i(r, "BAD_COLLECTION_TYPE", `${u.tag} used for ${l} collection, but expects ${u.collection ?? "scalar"}`, true) : i(r, "TAG_RESOLVE_FAILED", `Unresolved tag: ${o}`, true), it(s, e, t, i, o);
  }
...
function kn(s, e, t, n, i) {
  ...
  return o && !o.collection ? (s.tags.push(Object.assign({}, o, { default: false, test: void 0 })), o) : (i(n, "TAG_RESOLVE_FAILED", `Unresolved tag: ${t}`, t !== "tag:yaml.org,2002:str"), s[F]);
}
function Nn({ atKey: s, directives: e, schema: t }, n, i, r) {
  const o = t.tags.find((l) => (l.default === true || s && l.default === "key") && l.test?.test(n)) || t[F];
  if (t.compat) {
...
var An = { composeNode: Os, composeEmptyNode: Et };
function Os(s, e, t, n) {
  ...
  switch (e.type) {
    ...
    default: {
      ...
      n(e, "UNEXPECTED_TOKEN", f), c = Et(s, e.offset, void 0, null, t, n), d = false;
    }
  }
  return l && c.anchor === "" && n(l, "BAD_ALIAS", "Anchor cannot be an empty string"), i && s.options.stringKeys && (!E(c) || typeof c.value != "string" || c.tag && c.tag !== "tag:yaml.org,2002:str") && n(a ?? e, "NON_STRING_KEY", "With stringKeys, all keys must be strings"), r && (c.spaceBefore = true), o && (e.type === "scalar" && e.source === "" ? c.comment = o : c.commentBefore = o), s.options.keepSourceTokens && d && (c.srcToken = e), c;
}
function Et(s, e, t, n, { spaceBefore: i, comment: r, anchor: o, tag: l, end: a }, c) {
  ...
  return o && (f.anchor = o.source.substring(1), f.anchor === "" && c(o, "BAD_ALIAS", "Anchor cannot be an empty string")), i && (f.spaceBefore = true), r && (f.comment = r, f.range[2] = a), f;
}
function En({ options: s }, { offset: e, source: t, end: n }, i) {
  const r = new Fe(t.substring(1));
  r.source === "" && i(e, "BAD_ALIAS", "Alias cannot be an empty string"), r.source.endsWith(":") && i(e + t.length - 1, "BAD_ALIAS", "Alias ending in : is ambiguous", true);
...
function In(s, e, { offset: t, start: n, value: i, end: r }, o) {
  ...
  d.found && (a.directives.docStart = true, i && (i.type === "block-map" || i.type === "block-seq") && !d.hasNewline && o(d.end, "MISSING_CHAR", "Block collection cannot start on same line with directives-end marker")), a.contents = i ? Os(c, i, d, o) : Et(c, d.end, n, null, d, o);
  const f = a.contents.range[2], u = Ie(r, f, false, o);
...
var It = class {
  constructor(e = {}) {
    this.doc = null, this.atDirectives = false, this.prelude = [], this.errors = [], this.warnings = [], this.onError = (t, n, i, r) => {
      const o = be(t);
  ...
  *next(e) {
    switch (e.type) {
      ...
      case "document": {
        ...
        this.atDirectives && !t.directives.docStart && this.onError(e, "MISSING_CHAR", "Missing directives-end/doc-start indicator line"), this.decorate(t, false), this.doc && (yield this.doc), this.doc = t, this.atDirectives = false;
        break;
      }
      ...
      case "doc-end": {
        ...
        if (this.decorate(this.doc, true), t.comment) {
...
${t.comment}` : t.comment;
  ...
  *end(e = false, t = -1) {
    if (this.doc)
      ...
      this.atDirectives && this.onError(t, "MISSING_CHAR", "Missing directives-end indicator line"), i.range = [0, t, t], this.decorate(i, false), yield i;
    }
  }
};
function Tn(s, e = true, t) {
  if (s) {
    const n = (i, r, o) => {
...
function Ln(s, e) {
  const { implicitKey: t = false, indent: n, inFlow: i = false, offset: r = -1, type: o = "PLAIN" } = e, l = Ae({ type: o, value: s }, {
    implicitKey: t,
    indent: n > 0 ? " ".repeat(n) : "",
    inFlow: i,
...
function $n(s, e, t = {}) {
  let { afterKey: n = false, implicitKey: i = false, inFlow: r = false, type: o } = t, l = "indent" in s ? s.indent : null;
...
var ht = Symbol("break visit");
var vn = Symbol("skip children");
var Es = Symbol("remove item");
function x(s, e) {
...
var Ze = "";
var Oe = "";
var Bn = (s) => !!s && "items" in s;
var Mn = (s) => !!s && (s.type === "scalar" || s.type === "single-quoted-scalar" || s.type === "double-quoted-scalar" || s.type === "block-scalar");
function Kn(s) {
  switch (s) {
    case ze:
      return "<BOM>";
...
var jt = new Set("0123456789ABCDEFabcdef");
var Pn = new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()");
var _e = new Set(",[]{}");
var Dn = new Set(` ,[]{}
\r	`);
var ot = (s) => !s || Dn.has(s);
...
`, this.pos), this.lineEndPos = e), e === -1 ? this.atEnd ? this.buffer.substring(this.pos) : null : (this.buffer[e - 1] === "\r" && (e -= 1), this.buffer.substring(this.pos, e));
  ...
  *parseStream() {
    ...
    if (e[0] === ze && (yield* this.pushCount(1), e = e.substring(1)), e[0] === "%") {
      ...
      const i = (yield* this.pushCount(t)) + (yield* this.pushSpaces(true));
      return yield* this.pushCount(e.length - i), this.pushNewline(), "stream";
    }
    if (this.atLineEnd()) {
      const t = yield* this.pushSpaces(true);
  ...
  *parseLineStart() {
    ...
    return this.indentValue = yield* this.pushSpaces(false), this.indentNext > this.indentValue && !D(this.charAt(1)) && (this.indentNext = this.indentValue), yield* this.parseBlockStart();
  }
  *parseBlockStart() {
  ...
  *parseDocument() {
    ...
    switch (e[t]) {
      ...
      case "|":
      case ">":
        return t += yield* this.parseBlockScalarHeader(), t += yield* this.pushSpaces(true), yield* this.pushCount(e.length - t), yield* this.pushNewline(), yield* this.parseBlockScalar();
      default:
        return yield* this.parsePlainScalar();
    }
  }
  *parseFlowCollection() {
    let e, t, n = -1;
    do
      e = yield* this.pushNewline(), e > 0 ? (t = yield* this.pushSpaces(false), this.indentValue = n = t) : t = 0, t += yield* this.pushSpaces(true);
    while (e + t > 0);
    ...
    let r = 0;
    for (; i[r] === ","; )
      r += yield* this.pushCount(1), r += yield* this.pushSpaces(true), this.flowKey = false;
...
`, r);
    ...
    return yield* this.pushToIndex(t + 1, false), this.flowLevel ? "flow" : "doc";
  }
...
` && r >= this.pos && r + 1 + t > l)
    ...
    return yield Oe, yield* this.pushToIndex(e + 1, true), yield* this.parseLineStart();
  }
  *parsePlainScalar() {
...
`) {
    ...
    return !i && !this.atEnd ? this.setNext("plain-scalar") : (yield Oe, yield* this.pushToIndex(t + 1, true), e ? "flow" : "doc");
  }
  *pushCount(e) {
  ...
  *pushIndicators() {
    switch (this.charAt(0)) {
      ...
      case "&":
        return (yield* this.pushUntil(ot)) + (yield* this.pushSpaces(true)) + (yield* this.pushIndicators());
      case "-":
      // this is an error
      case "?":
  ...
  *pushTag() {
    if (this.charAt(1) === "<") {
      ...
      for (; !D(t) && t !== ">"; )
        t = this.buffer[++e];
      return yield* this.pushToIndex(t === ">" ? e + 1 : e, false);
    } else {
...
var Tt = class {
   ...
   */
  constructor(e) {
    this.atNewLine = true, this.atScalar = false, this.indent = 0, this.offset = 0, this.onKeyLine = false, this.stack = [], this.source = "", this.type = "", this.lexer = new Ls(), this.onNewLine = e;
  }
  /**
    ...
    if (!t)
      ...
      switch (t.type === "block-scalar" ? t.indent = "indent" in n ? n.indent : 0 : t.type === "flow-collection" && n.type === "document" && (t.indent = 0), t.type === "flow-collection" && Dt(t), n.type) {
        ...
        case "block-map": {
          ...
          if (i.value) {
            n.items.push({ start: [], key: t, sep: [] }), this.onKeyLine = true;
            return;
          } else if (i.sep)
            i.value = t;
          else {
  ...
  *scalar(e) {
    if (this.type === "map-value-ind") {
      ...
      this.onKeyLine = true, this.stack[this.stack.length - 1] = r;
    } else
...
`, t) + 1;
  ...
  *blockMap(e) {
    ...
    switch (this.type) {
      case "newline":
        if (this.onKeyLine = false, t.value) {
    ...
    if (this.indent >= e.indent) {
      ...
      switch (this.type) {
        case "anchor":
        case "tag":
          i || t.value ? (r.push(this.sourceToken), e.items.push({ start: r }), this.onKeyLine = true) : t.sep ? t.sep.push(this.sourceToken) : t.start.push(this.sourceToken);
          return;
        case "explicit-key-ind":
          !t.sep && !t.explicitKey ? (t.start.push(this.sourceToken), t.explicitKey = true) : i || t.value ? (r.push(this.sourceToken), e.items.push({ start: r, explicitKey: true })) : this.stack.push({
            type: "block-map",
            offset: this.offset,
            indent: this.indent,
        ...
        case "double-quoted-scalar": {
          ...
          i || t.value ? (e.items.push({ start: r, key: o, sep: [] }), this.onKeyLine = true) : t.sep ? this.stack.push(o) : (Object.assign(t, { key: o, sep: [] }), this.onKeyLine = true);
          return;
        }
        default: {
...
`, t) + 1;
  ...
  atIndentedComment(e, t) {
    return this.type !== "comment" || this.indent <= t ? false : e.every((n) => n.type === "newline" || n.type === "space");
  }
  *documentEnd(e) {
...
function qn(s, e = {}) {
  ...
  return o.length > 0 ? o : Object.assign([], { empty: true }, r.streamInfo());
}
function vs(s, e = {}) {
  const { lineCounter: t, prettyErrors: n } = Cs(e), i = new Tt(t?.addNewLine), r = new It(e);
  let o = null;
  for (const l of r.compose(i.parse(s), true, s.length))
    if (!o)
      o = l;
...
var Un = Object.freeze(Object.defineProperty({
  __proto__: null,
  Alias: Fe,
  CST: jn,
  Composer: It,
...
//# sourceMappingURL=index-DmNq2fbN-QTHQPZG5.js.map
